  ...
  return (
    <div className="page">
      ...
      <p>Morgan McDonald is a Junior from Ripon High School, California. He is an established front-end developer and academic achiever, with aspirations to achieve the highest level of education his family has seen yet.<br></br> <br></br> 
        ...
        The long-term goal of Morgan McDonald is to attend Cal Poly San Luis Obispo, and land a full-time job as a distinguished software engineer. <br></br> <br></br> 
        Orwell’s quote, located for your convenience front and center on the Home page, holds significant importance for Morgan due to his regard for the preservation of one’s historical records. Aside from 1984 being Morgan’s favorite novel, the quote reveals his attitude towards not only control but a means to balance one's life in the tidal storm it presents.
        </p>
    </div>
  );
}
